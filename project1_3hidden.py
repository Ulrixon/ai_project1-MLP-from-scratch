...
def weight_generator(afterlayer, nowlayer):
    weight = np.random.uniform(-1, 1, (nowlayer, afterlayer))
    return weight


weight_1 = weight_generator(inputlayer, hiddenlayer_1)
weight_2 = weight_generator(hiddenlayer_1, hiddenlayer_2)
weight_3 = weight_generator(hiddenlayer_2, hiddenlayer_3)
weight_output = weight_generator(hiddenlayer_3, outputlayer)
